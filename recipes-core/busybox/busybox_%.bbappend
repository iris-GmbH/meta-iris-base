...
FILES:${PN} += "${sysconfdir}/init.d/busybox_watchdog.sh \
                ...
                ${sysconfdir}/udhcpc.d/dhcp_option_42/starting_ntpdaemon.sh \
               "
...
udhcpoption42="${D}${sysconfdir}/udhcpc.d/dhcp_option_42"
...
do_install:append() {
	...
	install -m 0755 ${WORKDIR}/starting_ntpdaemon.sh ${udhcpoption42}/
