...
CORE_IMAGE_EXTRA_INSTALL += "libstdc++ libssl avahi-daemon libavahi-client libavahi-common libavahi-core protobuf-lite zlib yaml-cpp libelf libxml2"

# Include swupdate in image if swupdate is part of the update procedure
CORE_IMAGE_EXTRA_INSTALL += "${@bb.utils.contains('UPDATE_PROCEDURE', 'swupdate', 'swupdate', '', d)}"
